...
const CurrentItemLeftCarusel = () => {
    const settingsCarouselSingle = {
        dots: true, infinite: false, speed: 500, slidesToShow: 3, slidesToScroll: 3, initialSlide: 0, responsive: [{
    ...
    return (<div className="LeftCarouselContainer">
            <div className="">
                <div className="topContainer">
                    <img src={img} className="topImg" alt="asd"/>
                    <Slider {...settingsCarouselSingle} >
                        {leftCaruselData.map((el, index) => {
                            return (<div key={index} className="bottomImgCarusel">
                                    <img src={el.img} alt='yoga pics' className="sliderPics"
